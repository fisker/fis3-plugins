...
function resolveAndLoad(filename, dir) {
  ...
  var files = [_path.default.join(dirname, basename), _path.default.join(dirname, "_".concat(basename)), _path.default.join(dirname, "_".concat(basename, ".scss")), _path.default.join(dirname, "_".concat(basename, ".sass")), _path.default.join(dirname, "".concat(basename, ".scss")), _path.default.join(dirname, "".concat(basename, ".sass"))];
  var found = null;
...
module.exports = function (content, file, conf) {
  ...
  opts.includePaths = opts.includePaths.map(function (dir) {
    if (_path.default.resolve(dir) !== _path.default.normalize(dir) || fis.util.exists(_path.default.join(PROJECT_ROOT, dir))) {
  ...
  if (opts.sourceMap) {
    ...
    mapping = fis.file.wrap("".concat(file.dirname, "/").concat(file.filename).concat(file.rExt, ".map"));
  ...
  try {
    ...
    fis.log.error(_util.default.format('%s'.red + ' [`%s` %s:%s]'.yellow, error.message, error.file, error.line, error.column));
