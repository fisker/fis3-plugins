...
var _defaultConfig = _interopRequireDefault(require("browser-sync/dist/default-config.js"));
...
function getConfig(bs, argv) {
  var userConfig = getUserConfig(_path.default.resolve(argv.context, argv.bsConfig || bs.instance.config.userFile));
  var config = (0, _lodash.default)({}, defaultOptions, userConfig, overrideOptions, {
    server: {
      baseDir: argv.root
    },
